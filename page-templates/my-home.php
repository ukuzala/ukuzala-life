<?php
/**
 * Template Name: My Home Template
 *
...
<script src="<?php echo get_template_directory_uri(); ?>/js/moment.min.js"></script>
	...
	<div id="primary" class="site-content">
		<div id="content" role="main">
			...
			<h2>Home Luminosity</h2>
            
            <div class="knobChart"><input id="homeLuminosity" type="text" value="" class="knob second"></div>
...
jQuery(document).ready(function(jQuery) {  
  ...
  xively.datastream.get (feedID, datastreamID, function ( datastream ) {  
	...
	jQuery("#homeLuminosity").val(Math.round(dataVal));
    ...
    xively.datastream.subscribe( feedID, datastreamID, function ( event , datastream_updated ) {  
	  ...
	  jQuery("#homeLuminosity").val(Math.round(dataVal)).trigger("change");
    });  
